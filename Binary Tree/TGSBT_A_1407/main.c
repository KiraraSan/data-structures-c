...
int main(int argc, char *argv[]) {
	...
	int menu, ukuranSandal, depth, bin, desimal;
	...
	do {
		...
		switch (menu) {
			...
			case 4:
				printf("\nMasukkan bilangan biner : "); scanf("%d", &bin);
				desimal = convertBiner(bin);
				PB = alokasiBiner(desimal);
				insTreeBST(&BT_BNR, PB);
				printf("\n\tBerhasil input biner...");
				break;
