					...
					switch (submenu) {
						case 1:
							...
							while (true) {
								...
								scanf("%d", &D.date.hari);
								if (D.date.hari > 31) {
									printf("\n\tTanggal tidak lebih dari 31 [!]");
								} else {
									break;
								}
								printf("-"); scanf("%d", &D.date.bulan);
								if (D.date.bulan > 12) {
									printf("\n\tBulan tidak lebih dari 12 [!]");
								} else {
									break;
								}
								printf("-"); scanf("%s", &D.date.tahun);
								if (strlen(D.date.tahun) != 4) { 
									printf("\n\tTahun invalid [!]");
								} else {
									break;
								}
						...
						case 2:
							...
							printf("\n\tMasukkan setelah ID : "); scanf("%d", &idAt);
                			insertAfter(&L, alokasi(D), idAt);
							id++;
							break;
